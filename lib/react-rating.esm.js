  ...
  _createClass(Rating, [{
    ...
    value: function render() {
      ...
      for (var i = 0; i < totalSymbols; i++) {
        ...
        symbolNodes.push(React.createElement("div", null, React.createElement(RatingSymbol, _extends({
          key: i,
          index: i,
          readonly: readonly,
...
function (_React$PureComponent) {
  ...
  _createClass(RatingAPILayer, [{
    ...
    value: function translateDisplayValueToValue(displayValue) {
      var translatedValue = this.props.values[displayValue - 1]; // minimum value cannot be equal to start, since it's exclusive
